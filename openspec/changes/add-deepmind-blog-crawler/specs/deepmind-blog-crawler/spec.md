...
### Requirement: Crawl blog posts from DeepMind's website
The system SHALL fetch blog posts from https://deepmind.google/blog/ and extract structured data including title, URL, and publication date.
...
The system SHALL store crawled blog posts in a MongoDB collection named `deepmind_blog`.

#### Scenario: Insert new blog posts
- **WHEN** new blog posts are crawled
- **THEN** they SHALL be inserted into the `deepmind_blog` collection
