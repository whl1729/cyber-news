...
def test_ruanyifeng_weekly_parser():
    ...
    photos = ["1、还原致命的原子弹实验事故"]
    summary = ["1、73亿人，一栋小楼"]

    assert result["created_at"] == "2024-08-30T08:08:59+08:00"
    assert result["hot_news"] == hot_news
...
if __name__ == "__main__":
    # test_ruanyifeng_blog_parser()
    # test_find_latest_blog()
