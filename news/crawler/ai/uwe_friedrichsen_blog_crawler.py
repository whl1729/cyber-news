...
UWE_FRIEDRICHSEN_RSS_URL = "https://ufried.com/blog/index.xml"
COLLECTION_NAME = "uwe_friedrichsen_blog"
...
class UweFriedrichsenBlogParser(WebParser):
    def parse(self, resp_text: str) -> List[dict]:
        ...
        logger.info(f"{len(blog_list)} uwe friedrichsen blog posts parsed")
        return blog_list
    ...
    def _parse_item(self, item) -> dict:
        try:
            ...
            logger.warning(f"Failed to parse uwe friedrichsen blog item: {e}")
            return None


def crawl():
    parser = UweFriedrichsenBlogParser()
    web_crawler.crawl(
        parser,
        UWE_FRIEDRICHSEN_RSS_URL,
        COLLECTION_NAME,
