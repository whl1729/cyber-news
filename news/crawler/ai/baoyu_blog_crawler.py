...
BAOYU_BLOG_RSS_URL = "https://baoyu.io/feed.xml"
COLLECTION_NAME = "baoyu_blog"
...
class BaoyuBlogParser(WebParser):
    def parse(self, resp_text: str) -> List[dict]:
        ...
        logger.info(f"{len(blog_list)} baoyu blog posts parsed")
        return blog_list
